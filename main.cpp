    ...
    static void check_06(string input_file, string output_file)
    {
        ...
        for (int i = 0; i < num_steps; i++)
        {
            ...
            if (i == 6)
            {
                ...
                robotS = new RobotS(3, temp_pos, map, criminal, sherlock);
    ...
    static void check_07(string input_file, string output_file)
    {
        ...
        for (int i = 0; i < num_steps; i++)
        {
            ...
            if (i == 9)
            {
                ...
                robotW = new RobotW(3, temp_pos, map, criminal, watson);
    ...
    static void check_08(string input_file, string output_file)
    {
          ...
          i++)
        {
            ...
            if (i == 12)
            {
                ...
                robotSW = new RobotSW(3, temp_pos, map, criminal, sherlock, watson);
                assert(robotSW != NULL);
                outfile << robotSW->str() << endl;
                //outfile << "Index : " << robotSW->index << endl;
